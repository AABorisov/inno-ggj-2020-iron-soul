// bg
const microphone = require("./bg/bg-city.jpg");
const entrance = require("./bg/bg-entrance.jpg");
// bgm
const take = require("./bgm/broken-elegance-elan.mp3");
// speakers
const b = "Продавец";
// sprites
const bn = require("./sprites/salesman.png");
const bh = require("./sprites/salesman.png");
const bp = require("./sprites/salesman.png");
